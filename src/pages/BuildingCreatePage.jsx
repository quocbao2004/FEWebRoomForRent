    ...
    <div>
      ...
      <li>
        ...
        <input
          ...
          name="floorArea"
          id="floorArea"
          onChange={(e) => (building.floorArea = parseInt(e.target.value))}
        />
      </li>
      <li>
      ...
      <li>
        ...
        <input
          ...
          name="rentPrice"
          id="rentPrice"
          onChange={(e) => (building.rentPrice = parseInt(e.target.value))}
        />
      </li>
      <li>
        ...
        <input
          ...
          name="servicefee"
          id="servicefee"
          onChange={(e) => (building.servicefee = parseInt(e.target.value))}
        />
      </li>
      <li>
        ...
        <input
          ...
          name="carfee"
          id="carfee"
          onChange={(e) => (building.carfee = parseInt(e.target.value))}
        />
      </li>
      <li>
        ...
        <input
          ...
          name="motofee"
          id="motofee"
          onChange={(e) => (building.motofee = parseInt(e.target.value))}
        />
      </li>
      <li>
        ...
        <input
          ...
          name="waterfee"
          id="waterfee"
          onChange={(e) => (building.waterfee = parseInt(e.target.value))}
        />
      </li>
      <li>
        ...
        <input
          ...
          name="electricityfee"
          id="electricityfee"
          onChange={(e) => (building.electricityfee = parseInt(e.target.value))}
        />
      </li>
      <li>
        <label htmlFor="totalNumberOfAvailableRooms">
          totalNumberOfAvailableRooms
        </label>
        <input
          type="text"
          ...
          onChange={(e) =>
            (building.totalNumberOfAvailableRooms = parseInt(e.target.value))
          }
        />
      </li>
      <li>
      ...
      <div>
        <button onClick={() => createBuildingBtnHandler(api, building)}>
          Confirm
        </button>
      </div>
      <Footer />
